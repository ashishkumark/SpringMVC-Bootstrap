...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">SpringMVC with Twitter Bootstrap</a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href='<spring:url value="http://google.com" />'>Google</a></li>
                <li><a href='<spring:url value="http://getbootstrap.com" />'>Twitter Bootstrap</a></li>
                <li><a href='<spring:url value="http://github.com" />'>GitHub</a></li>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<form class="form-horizontal" method="post" action='employee/add.do' name="employeeForm" id="employeeForm">
	...
	<div id="README">
	spring1: Kitchensink Example using Spring 4.x
==============================================================
Author: Marius Bogoevici, Tejas Mehta, Joshua Wilson  
Level: Intermediate  
Technologies: JSP, JPA, JSON, Spring, JUnit  
Summary: The `spring1` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `spring1` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="com.ashish.spring.controller"/>` 
...
4. This will deploy `target/spring1.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/spring1/>.
